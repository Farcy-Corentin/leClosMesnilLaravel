...
/* harmony export */   "TelInputOptions": () => (/* binding */ TelInputOptions),
/* harmony export */   "PhoneNumberUtils": () => (/* binding */ PhoneNumberUtils),
...
var translateCountries = {
  'en': 'gb'
};

function selectLang() {
  var selectLang = document.querySelector('html').lang || 'fr';
...
var PhoneNumberUtils = /*#__PURE__*/function () {
  ...
  _createClass(PhoneNumberUtils, null, [{
    ...
    value: function isLoaded() {
      return 'intlTelInputUtils' in window && 'formatNumber' in window.intlTelInputUtils;
    }
  }, {
    key: "assertUtilsLoaded",
    value: function assertUtilsLoaded() {
    ...
    key: "format",
    value: function format(phone, country, _format) {
      PhoneNumberUtils.assertUtilsLoaded(); // noinspection JSUnresolvedFunction

      return window.intlTelInputUtils.formatNumber(phone, country, _format);
    }
  }, {
    key: "forceLoad",
    value: function forceLoad() {
      return new Promise(function (res) {
        ...
        var instance = new PhoneNumberInput(input, function () {
          var removed = input.parentNode;
...
var PhoneNumberInput = /*#__PURE__*/function () {
  function PhoneNumberInput(input, handlerLoaded) {
    _classCallCheck(this, PhoneNumberInput);

    var that = this;
    this.instanceITI = intl_tel_input__WEBPACK_IMPORTED_MODULE_0___default()(input, TelInputOptions);
  ...
  _createClass(PhoneNumberInput, [{
    ...
    value: function isMobile() {
      PhoneNumberUtils.assertUtilsLoaded();
      var acceptedTypes = [window.intlTelInputUtils.numberType.MOBILE, window.intlTelInputUtils.numberType.FIXED_LINE_OR_MOBILE];
      return this.isValid() && acceptedTypes.indexOf(this.instanceITI.getNumberType()) !== -1;
    }
  }, {
    key: "getNational",
    value: function getNational() {
      return this.isValid() ? this.instanceITI.getNumber(PhoneNumberUtils.getFormat('NATIONAL')) : '';
    }
  }, {
    key: "getE164",
    value: function getE164() {
