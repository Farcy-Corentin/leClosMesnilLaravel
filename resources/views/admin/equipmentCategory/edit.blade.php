        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.equipmentCatgory.update', ['equipment_category' => $equipmentCategory->id])}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row my-4">
                                <div class="col-md-12">
                                    <input id="name" type="text"
                                           ...
                                           value="{{ $equipmentCategory->name }}" autofocus>
                                    @error('name')
