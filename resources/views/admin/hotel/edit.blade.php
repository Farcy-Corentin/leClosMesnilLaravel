        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.hotel.update', ['hotel' => $hotel->id])}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row my-4">
                                ...
                                <div class="col-md-12">
                                    <input id="description" type="text"
                                           ...
                                           value="{{ $hotel->description }}" autofocus>
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
